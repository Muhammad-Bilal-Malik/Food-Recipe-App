...
import qorma from "../../Assets/qorma.jpeg";
export const RecipeIngredientsModal = ({ closeModal, recipeDetails }) => {
  console.log("recipedetai", recipeDetails);
  return (
    <div
      onClick={closeModal}
      ...
      >
        ...
        <div className="overflow-hidden flex h-[85%] gap-10">
          ...
          <div className="flex flex-col w-full">
            ...
            <h1 className=" font-semibold">{recipeDetails.title}</h1>
